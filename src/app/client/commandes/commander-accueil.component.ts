...
export class CommanderAccueilComponent extends PageBaseComponent implements OnInit {

    static _pageDef: PageDef = ClientPages.commandes;
    ...
    constructor(
        protected service: CommanderService,
    ) {
        super();
    }
