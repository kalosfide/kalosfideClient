...
import { DocumentLivraison } from '../../documents/document-commande';

@Injectable()
export class CDocumentLivraisonResolverService implements Resolve<DocumentLivraison> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<never> | Observable<DocumentLivraison> {
        ...
        return this._service.livraison$({
